...
// import { UserPriorityDto } from './dto/user-priority.dto';
//
...
//   }
//
//   private formatPriorities (data: UserPriorityDto) {
//     const priorities = {};
...
//     }
//
//     const day = data.date.padStart(2, '0');
...
//   }
//
//   private async sendPriorities (data: UserPriorityDto[], sendToEntrant: boolean) {
//     const attachments = [];
//
...
//     const entrant = await this.userRepo.find({ id });
//     if (entrant.userPriorities.length === 0) throw new BadRequestException(DATA_NOT_FOUND_MSG);
//
//     const priorities: PriorityDto[] = [];
//     entrant.userPriorities.forEach((entrantPriority) => {
//       const priorityList = {};
...
//   }
//
//   private validatePrograms ({ specialty, priorities }: UserPriorityDto) {
...
//   }
//
//   async generatePriority (data: UserPriorityDto) {
//     this.validatePrograms(data);
//     const user = await this.userRepo.find({ id: data.userId });
//
//     const priorities = [];
